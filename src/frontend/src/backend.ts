...
export class Backend implements backendInterface {
    ...
    async getAllCarrierSignups(): Promise<Array<CarrierSignup>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCarrierSignups();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async submitCarrierSignup(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitCarrierSignup(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
